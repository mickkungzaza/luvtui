  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="font-script text-3xl text-primary leading-tight">
          ตึงตังและครอบครัวหมี
        </p>
        <p className="font-hand text-xl mt-2 text-foreground">
          รักตุ๊ต๊ะที่สุดในพหุจักรวาลลล
        </p>
        <button
          onClick={onClose}
